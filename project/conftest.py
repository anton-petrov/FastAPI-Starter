...
from project.db.pg.dependencies import get_db_session
from project.db.pg.utils import create_database, drop_database
from project.services.rabbit.dependencies import get_rmq_channel_pool
from project.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from project.services.redis.dependency import get_redis_pool
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from project.db.pg.meta import meta  # noqa: WPS433
    from project.db.pg.models import load_all_models  # noqa: WPS433
